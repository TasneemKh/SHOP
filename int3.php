...
if(isset($_POST['btnSubmit'])){ 
		...
		$txtMsg=$_POST['txtMsg']; 
		if( ($email != null)&& ($txtMsg != null)){
		$sql="INSERT INTO `contact` (`name`, `email`, `phone`, `messageCon`) VALUES ('$username', '$email', '$phoneNo', '$txtMsg')";
		   if ($conn->query($sql) === TRUE) {
		$done = "Thanks for chooseing us <br> we will conact with you in less 24 hour"; 
	  echo "<script type='text/javascript'>alert('$done');</script>";
       ...
       echo "<script type='text/javascript'>alert('$message');</script>";}
		...
		else{$message = "somthing went wrong check that email and message not null";
       echo "<script type='text/javascript'>alert('$message');</script>";}
    }
	
if(isset($_POST['postQues'])){
...
$sql_e="SELECT * FROM user WHERE email='$em'";
    ...
    if(mysqli_num_rows($res_e) > 0){
        ...
        $messagetext = $_POST['message-text']; 
		 $sql="INSERT INTO `ques` (`id`, `question`, `iduser`) VALUES (NULL, '$messagetext', '$id')";

            if ($conn->query($sql) === TRUE) {
			$done = "your Question was posted"; 
			echo "<script type='text/javascript'>alert('$done');</script>";}
...
if(isset($_POST['cart'])){
	...
	$price = $_POST["hidden_price"];
	 $sqlcart="INSERT INTO `cart` (`id`, `name`, `price`, `userid`, `proId`) VALUES (NULL, '$name', '$price', '$idu', '$id')";
	 if ($conn->query($sqlcart) === TRUE) {
			$done = "your product was added to cart $name "; 
			echo "<script type='text/javascript'>alert('$done');</script>";}
     }else{$message = "something went wrong ";
echo "<script type='text/javascript'>alert('$message');</script>";}

	}
else{$message = "you need to sign up  ";
echo "<script type='text/javascript'>alert('$message');</script>";}
}
...
.btn-primary {
    color: #fff;
    background-color: #bfa928 !important;
    border-color: #bfa928 ;
}
</style>
<script type="text/javascript">
  ...
  <body>
  <div id="mybutton" >
<button class="feedback" type="button" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-thumbtack"></i></button>
</div>
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Create an inquiry </h5>
      ...
      <div class="modal-body">
        <form method="post">
		  ...
		  <small>you must sign in to website to have the chance to ask your question   </small>
            <label for="message-text" class="col-form-label" style="display:block">Question:</label>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="postQues" class="btn btn-primary">post inquiry</button>
      </div>
	  </form>
    </div>
  </div>
...
<div class="col-md-6">
<h1 style="color:#bfa928;font-size: 3.5rem;">Welcome To <span>CM</span></h1>
<p class="px-5" style="font-size: smaller;font-family: serif;">It’s the perfect time to buy a laptop! They are more affordable than ever—especially if you buy them from an online store. There's a much better selection online for you to explore
<br>
...
<div class="col-md-2">
 <a href="#products" class="btn wow bounce" duration="800ms"><i class="fas fa-angle-double-down fa-3x" style="color: #bfa9285e"></i>
</a></div>
<div class="col-md-5"></div>
</div>
</div>

<div class="container p-5 mt-5" id="products">
...
$name=$post["name"];
$price=$post["price"];
$dis=$post["discribtion"];
?>
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img class="card-img-top"  style="height: 225px; width: 100%; display: block;" src="<?php echo $img;?>" data-holder-rendered="true">
                <div class="card-body">
				<h5 class="card-title"><?php echo $name;?></h5>
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
					 ...
					 <button type="button" class="btn btn-sm btn-outline-secondary"><i class="fas fa-dollar-sign"><?php echo $price;?></i></button>
					   <input type="hidden" name="hidden_name" value="<?php echo $name; ?>" />  
					   <input type="hidden" name="hidden_price" value="<?php echo $price; ?>" />   
                        <input type="hidden" name="hidden_id" value="<?php echo $id; ?>" />  					   
					 <button type="submit" name="cart" class="btn btn-sm btn-outline-secondary"><i class="fas fa-cart-plus"></i></button>
                  	</form >
				  </div>              
                  </div>
                </div>
...
Condensation will build on computer's components and cause them to degrade or even short out.
  ...
  <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab"><h3>software Maintenance</h3>
  ...
  <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
            ...
            <form method="post">
               ...
               <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" name="txtName" id="txtName"class="form-control" placeholder="Your Name *" value="" />
                        </div>
                        <div class="form-group">
                            <input type="text" name="txtEmail" id="txtEmail"class="form-control" placeholder="Your Email *" value="" />
                        </div>
                        <div class="form-group">
                            <input type="text" name="txtPhone" id="txtPhone" class="form-control" placeholder="Your Phone Number *" value="" />
                        </div>
                        <div class="form-group">
